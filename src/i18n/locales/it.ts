...
const it: Record<TranslationKey, string> = {
  ...
  'color.info': 'Genera 5 layer separati (Bianco base, G, M, C, Bianco top). Il Bianco base controlla la luminosità con lo spessore; C/M/G sono filtri colore sottili; Bianco top è un diffusore.',
  'color.channel': 'Canale anteprima',
  'color.composite': 'Composito',
  'color.cyan': 'Ciano',
  'color.magenta': 'Magenta',
  'color.yellow': 'Giallo',
  'color.white': 'Bianco Base',
  'color.white_top': 'Bianco Top',
  ...
  'menu.save': 'Salva Progetto',
  'menu.export': 'Esporta (.json)',
  'menu.import': 'Importa Progetto',
  'menu.history': 'Cronologia Progetti',
