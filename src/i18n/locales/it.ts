...
const it: Record<TranslationKey, string> = {
  ...
  'palette.modeQuick': 'CMYW Rapido',
  'palette.modePalette': 'Modalità Palette',
  'palette.modeLabel': 'Modalità Motore',
  'palette.modeQuickHint': 'Decomposizione C/M/Y/W a 5 strati — veloce, nessuna calibrazione necessaria.',
  'palette.modePaletteHint': 'Palette CIELab dai filamenti AMS — massima precisione colore.',
  'palette.filamentLibrary': 'Libreria Filamenti',
  'palette.search': 'Cerca filamenti…',
  'palette.addFilament': 'Aggiungi Filamento',
  'palette.deleteFilament': 'Rimuovi',
  'palette.editTd': 'Modifica TD',
  'palette.calibrated': 'Calibrato',
  'palette.import': 'Importa JSON',
  'palette.export': 'Esporta JSON',
  'palette.resetLibrary': 'Ripristina Predefiniti',
  'palette.name': 'Nome Filamento',
  'palette.brand': 'Marca',
  'palette.material': 'Materiale',
  'palette.noResults': 'Nessun filamento corrisponde alla ricerca.',
  'palette.emptyLibrary': 'La libreria è vuota.',
  'palette.amsSlots': 'Slot AMS',
  'palette.addSlot': 'Aggiungi Slot',
  'palette.removeSlot': 'Rimuovi Slot',
  'palette.maxLayers': 'Strati Colore Max',
  'palette.layerHeight': 'Altezza Strato',
  'palette.printParams': 'Parametri di Stampa',
  'palette.manageLibrary': 'Gestisci Libreria Filamenti',
  'palette.noWhiteWarning': 'Nessun filamento bianco rilevato. Una base bianca è consigliata per il controllo della luminosità — senza, i risultati potrebbero apparire spenti.',
  'palette.gamutCoverage': 'Copertura Gamut',
  'palette.avgDeltaE': 'ΔE Medio',
