const en = {
  ...
  // Palette engine / Filament Manager
  ...
  'palette.noWhiteWarning': 'No white filament detected. A white base is recommended for luminosity control — without it, results may appear muddy.',
  'palette.gamutCoverage': 'Gamut Coverage',
  'palette.avgDeltaE': 'Avg ΔE',
