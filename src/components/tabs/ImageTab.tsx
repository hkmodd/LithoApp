    ...
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
      {mode === 'extrusion' ? (
        <div className="space-y-3">
          ...
          <TouchSlider min={0} max={255} step={1} value={threshold} onChange={(v) => updateLithoParams({ threshold: v })} />
        ...
        <>
          <div className="space-y-3">
            ...
            <TouchSlider min={0.0} max={3.0} step={0.1} value={contrast} onChange={(v) => updateLithoParams({ contrast: v })} />
          </div>
          ...
          <div className="space-y-3">
            ...
            <TouchSlider min={-1.0} max={1.0} step={0.05} value={brightness} onChange={(v) => updateLithoParams({ brightness: v })} />
          </div>
          ...
          <div className="space-y-3">
            ...
            <TouchSlider min={0.0} max={2.0} step={0.1} value={sharpness} onChange={(v) => updateLithoParams({ sharpness: v })} />
